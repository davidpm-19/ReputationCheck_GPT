            ...
            <div className="flex flex-col w-full stretch border-">
                <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="item-2">
                        ...
                        <AccordionContent className="AccordionContent">
                            Yes. It uses the assistant and completion apis from Vercel AI SDK to simplify the process of making requests allowing user to type human sentences instead of just an IP, it also uses completion to call models and provide information about some elements and calculate the risk score.
                        </AccordionContent>
                    </AccordionItem>
